///
/// forked from https://www.tiptap.dev/experiments/global-drag-handle/#globaldraghandle
///
          ...
          handleDOMEvents: {
            ...
            mousemove(view, event): boolean {
              ...
              if (pos) {
                ...
                if (node) {
                  let nnode: HTMLElement = node.node as HTMLElement;
                  while (nnode && nnode.parentNode) {
                    if (
                      (nnode.parentNode as HTMLElement)?.classList?.contains(
                        "ProseMirror"
                      )
                    ) {
                      // todo
                    ...
                    nnode = nnode.parentNode as HTMLElement;
                  }
